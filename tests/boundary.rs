...
fn persona_spirit_client_accepts_request_file_path_argument() {
    ...
    fs::write(
        &request_path,
        "(Record (workspace Decision \"file request\" \"path context\" Maximum (2026 5 20) (14 30 0) \"path quote\"))",
    )
...
fn persona_spirit_client_asserts_entry_and_mints_record_identifier() {
    ...
    let reply = fixture
        .reply_text("(Record (workspace Decision \"summary only\" \"current implementation context\" Maximum (2026 5 20) (14 30 0) \"first statement\"))")
...
fn persona_spirit_client_persists_entries_for_later_summary_observation() {
    ...
    fixture
        .reply_text("(Record (workspace Decision \"first summary\" \"current implementation context\" Maximum (2026 5 20) (14 30 0) \"first statement\"))")
        .expect("first entry persisted");
    fixture
        .reply_text("(Record (workspace Correction \"second summary\" \"current implementation context\" Medium (2026 5 20) (14 30 1) \"second statement\"))")
...
fn persona_spirit_client_opens_record_subscription_with_summary_snapshot() {
    ...
    fixture
        .reply_text("(Record (workspace Decision \"subscription summary\" \"workspace context\" Maximum (2026 5 20) (14 30 0) \"workspace quote\"))")
        .expect("entry persisted");
...
fn persona_spirit_client_filters_record_observation_by_topic() {
    ...
    fixture
        .reply_text("(Record (workspace Decision \"workspace summary\" \"workspace context\" Maximum (2026 5 20) (14 30 0) \"workspace quote\"))")
        .expect("workspace entry persisted");
    fixture
        .reply_text("(Record (naming Correction \"naming summary\" \"naming context\" Maximum (2026 5 20) (14 30 1) \"naming quote\"))")
...
fn persona_spirit_client_repeated_entries_remain_distinct_records() {
    ...
    fixture
        .reply_text("(Record (naming Correction \"drop ancestor prefixes\" \"first context\" Maximum (2026 5 20) (14 30 0) \"first wording\"))")
        .expect("first entry persisted");
    fixture
        .reply_text("(Record (naming Correction \"drop ancestor prefixes\" \"second context\" Maximum (2026 5 20) (14 30 1) \"second wording\"))")
        .expect("second entry persisted");
